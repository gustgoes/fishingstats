...
function Badge({ code, name }) {
  return (
    <img
      ...
      style={{ imageRendering: "pixelated", height: "auto", width: "auto", maxHeight: 40 }}
    />
  );
}
...
function XpBar({ value, max, color = "#ffc76a", bg = "#312d19" }) {
  ...
  return (
    <div style={{
      ...
      width: "100%",
      margin: "6px 0",
      boxShadow: "0 1px 4px #0004 inset,0 1px 0 #fff2"
    }}>
      <div style={{
        width: `${percent}%`,
        height: "100%",
        background: `linear-gradient(90deg, ${color} 70%, #ffe6a0 100%)`,
        borderRadius: 11,
        boxShadow: percent ? "0 1px 5px #f7c76655 inset,0 0px 1.5px #fff5" : undefined,
        transition: "width 0.35s cubic-bezier(.9,.1,.2,1)"
      }} />
    </div>
  );
}
      ...
      >
        ...
        >
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <XpBar value={data.experience} max={getNextLevelXp(data.level)} />
          ...
          <div className="flex justify-center mb-3">
            <img src="/img/ranking.png" alt="Ranking" style={{ height: 64, objectFit: "contain" }} />
          </div>
            ...
            {ranking.map((player, index) => {
              ...
              return (
                <li
                  ...
                  style={{
                    background: "rgba(37,28,18,0.91)",
                    border: "1.5px solid rgba(128,84,44,0.14)",
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <img
                        ...
                        alt="Avatar"
                        style={{ width: 62, height: 110, imageRendering: "pixelated", background: "#31241d", borderRadius: 8 }}
                    ...
                    <span className="text-base font-mono font-bold" style={{ color: "#ffc76a" }}>
                      {player.level}
                    </span>
                  </div>
